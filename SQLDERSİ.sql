...
(
id CHAR(5) PRIMARY KEY, ---- Primary Key --> Bir sutunun NULL içermemesini ve sutundaki verilerin BENZERSİZ olmasını sağlar (NOT NULL - UNIQUE)
...
INSERT INTO calisanlar VALUES('10007', 'CAN', 5000, '2018-04-14');--unıque can ' ı ıkı defa kullandın dıyor'
INSERT INTO calisanlar VALUES('10009', 'cem', '', '2018-04-14');-- not null içinde deger yok
INSERT INTO calisanlar VALUES('', 'osman', 2000, '2018-04-14');
INSERT INTO calisanlar VALUES('', 'osman can', 2000, '2018-04-14');--prımary key yukarıda aynısı var o yuzden kabul etmedı
INSERT INTO calisanlar VALUES( '10002', 'ayse Yılmaz' ,12000, '2018-04-14');--prımary key
INSERT INTO calisanlar VALUES( null, 'filiz ' ,12000, '2018-04-14');-- prımary key daha null deger aldıgı ıcın kaydetmedi
